#!/usr/bin/env bash
# Give Claude Code a distinct, auditable git author identity (§2R.3 of
# docs/constitution-enforcement-handoff.md; mirrored from the fux engine repo).
#
...
git -C "$REPO_ROOT" config user.email "claude-code@anton.local"
