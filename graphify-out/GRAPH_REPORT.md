...
## Corpus Check
- 407 files · ~1,974,908 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2411 nodes · 4052 edges · 78 communities detected
- Extraction: 61% EXTRACTED · 39% INFERRED · 0% AMBIGUOUS · INFERRED: 1563 edges (avg confidence: 0.72)
...
Cohesion: 0.02
Nodes (175): AngelOneSource, _holding_from_csv(), _holding_from_row(), Angel One holdings — BrokerSource impl over CDP browser fetch + on-disk cache., BrokerSource, Adapter for one holdings provider — override `fetch()`., dump_binance(), is_csv_fresh() (+167 more)

### Community 1 - "Community 1"
Cohesion: 0.03
Nodes (92): ABC, default_model(), health(), NewsSource, ProviderAdapter, ProviderHealth, NewsSource abstract base class — the contract every source must implement., The provider's default model id — the first entry in `providers.json`. (+84 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (121): capture_angelone_cash(), _pick_cash(), Angel One — capture free-cash balance via CDP from the funds page.  Probe-confir, _to_float(), main(), Print Angel One free cash via CDP capture of /funds/v2/getRMSLimit.  Attaches to, _capture(), main() (+113 more)

### Community 3 - "Community 3"
Cohesion: 0.04
Nodes (94): detect_action(), Action confirmation — detect a mutating intent in the user's message and emit a, A structured pending-action card for a mutating intent, else None., next(), check(), main(), concierge(), stream_chat() (+86 more)
...
Cohesion: 0.05
Nodes (91): BaseModel, _doc_id(), _hits(), is_investment(), main(), _mtime(), check(), _fixture() (+83 more)
...
Cohesion: 0.06
Nodes (47): _bin(), _dir(), get(), list_docs(), Bridge to the elgar plan store — subprocess, same pattern as `fux_bridge`.  Savi, Write a doc into the store; returns its `elgar://plan/<id>` ref., All store docs (`{id, status, title}`), optionally filtered by id prefix., Docs in a collection (`{id, status, title}`), optionally filtered by id prefix. (+39 more)
...
- **What is the exact relationship between `BaseBroker / BrokerSource abstraction` and `BaseBroker / BrokerSource abstraction`?**
  _Edge tagged AMBIGUOUS (relation: conceptually_related_to) - confidence is low._
- **Why does `get()` connect `Community 0` to `Community 1`, `Community 2`, `Community 3`, `Community 5`, `Community 6`, `Community 7`, `Community 9`, `Community 11`, `Community 12`, `Community 14`, `Community 15`, `Community 16`, `Community 17`, `Community 20`, `Community 55`, `Community 23`, `Community 30`?**
  _High betweenness centrality (0.192) - this node is a cross-community bridge._
- **Why does `QueryType` connect `Community 3` to `Community 0`, `Community 1`, `Community 5`, `Community 6`, `Community 17`?**
...
- **Are the 103 inferred relationships involving `str` (e.g. with `run()` and `_shape_summary()`) actually correct?**
